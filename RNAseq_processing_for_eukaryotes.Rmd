...
bars <- rbind(panther.bpslim, panther.ccslim, panther.mfslim)
bars$log10FDR <- -log10(bars$log10FDR)

p <-ggplot(bars, aes(x=GO, y=log10FDR, fill=term))
p +geom_bar(stat = "identity") + coord_flip() + ylab("-log10(FDR)") + xlab("GO term") + ggtitle("Over-represented GO terms in upregulated gene set")

#now look at underregulated gene set
...
bars <- bars %>% filter(log10FDR > 4)

p <-ggplot(bars, aes(x=GO, y=log10FDR, fill=term))
p +geom_bar(stat = "identity") + coord_flip() + ylab("-log10(FDR)") + xlab("GO term") + ggtitle("Over-represented GO terms in downregulated gene set")
